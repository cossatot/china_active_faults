...
if save_results == true
    ...
    "../block_data/chn_faults_out_insar.geojson",
    name="China fault slip rates (w/ InSAR)")
end
...
if save_results == true
    CSV.write("../block_data/block_vels_insar.csv", centroids_pred_df)

    CSV.write("../block_data/block_poles_eur_rel_insar.csv", 
...
if save_results == true
    CSV.write("../block_data/pred_gnss_insar.csv", pred_gnss_df)
end
...
if save_results == true
    savefig("../../../china_faults_paper/figs/fault_rates_insar.pdf")
end
